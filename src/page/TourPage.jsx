...
function TourPage() {
  ...
  return (
    <div className="mt-10 mb-20 min-h-250">
      ...
      <Container className="grid xl:grid-cols-[1fr_4fr] grid-cols-1 gap-10 ">
        <SortOption />

        <div className=" border-gray-500 rounded-2xl h-min xl:px-5">
          <DisplayOption setView={setView} view={view} />

          {view.toLowerCase() === 'list' && <div className="flex flex-col gap-5 py-5">
            <TourInfoHorVer
              id="test"
              time="5N4D"
              start="Ha noi"
              price="1000000"
              image="\assets\imgs\sp4.webp"
              name="Du lịch Nha Trang - VinWonders Nha Trang - Hòn Mun 3N2Đ"
            />
            <TourInfoHorVer
              id="test"
              time="5N4D"
          ...
          {view.toLowerCase() === 'grid' && <div className="grid 2xl:grid-cols-3 md:grid-cols-2 gap-5 py-5">
